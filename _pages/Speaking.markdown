...
### DevOps Sydney: Automating Infrastructure Governance with Azure Policy
#### [ :floppy_disk: [slides](/assets/pdfs/SydDevOps2021_AutomateInfraGovWithAzPolicy.pdf) ]
...
### Azure Sydney User Group: Azure Policy as Code - Zero to Hero in 60 minutes
#### [ :floppy_disk: [slides](/assets/pdfs/AzureSydUserGroup2021_PolicyAsCode_ZeroToHero60min.pdf) ]
...
#### [ :floppy_disk: [slides](/assets/pdfs/GlobalAzure2021_PolicyAsCodeWithBicepForEnterpriseScale.pdf) ]
...
#### [ :floppy_disk: [slides](/assets/pdfs/DRY_CodingwithTerraformCSVsForEach.pdf) ]

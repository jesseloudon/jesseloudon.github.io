...
2. [Pluralsight - John Savill's AZ400 course](https://app.pluralsight.com/library/courses/introduction-az-400-designing-implementing-microsoft-devops-solutions-exam/table-of-contents) - Paid
...
7. Paste in your unformatted AZ-400 exam sections/sentences into the `Request Body / "text":` value
8. Hit Send
...
> Note1: Your Document size must be 5,120 or fewer characters per document, and you can have up to 1,000 items (IDs) per collection. Src: [Microsoft](https://docs.microsoft.com/en-us/azure/cognitive-services/text-analytics/how-tos/text-analytics-how-to-keyword-extraction#preparation)

> Note2: When I submitted the unformatted AZ400 skills outline there were 9806 characters total so I broke this up into two seperate request submissions/documents.
